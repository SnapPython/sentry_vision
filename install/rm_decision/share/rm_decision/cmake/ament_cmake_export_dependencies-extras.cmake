...
set(_exported_dependencies "rclcpp;rclcpp_components;sensor_msgs;tf2;geometry_msgs;tf2_ros;std_msgs;tf2_geometry_msgs;nav2_msgs;nav_msgs;lifecycle_msgs;yaml-cpp;rm_decision_interfaces;auto_aim_interfaces;behaviortree_cpp;behaviortree_ros2")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to rm_decision_DEFINITIONS, rm_decision_INCLUDE_DIRS,
# rm_decision_LIBRARIES, and rm_decision_LINK_FLAGS.
# Additionally collect the direct dependency names in
# rm_decision_DEPENDENCIES as well as the recursive dependency names
# in rm_decision_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(rm_decision_DEPENDENCIES ${_exported_dependencies})
  set(rm_decision_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rm_decision_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(rm_decision_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(rm_decision_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(rm_decision_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(rm_decision_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND rm_decision_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
