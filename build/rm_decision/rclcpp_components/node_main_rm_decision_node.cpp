...
#define NODE_MAIN_LOGGER_NAME "rm_decision_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_decision.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_decision::Commander>";
