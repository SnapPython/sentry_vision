...
: ${AMENT_CURRENT_PREFIX:="/home/mechax/ylh/sentry_vision/install/rm_decision"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm_decision/environment/library_path.sh"
